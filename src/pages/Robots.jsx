...
import { FaUser, FaShieldAlt, FaSearch } from "react-icons/fa";
    ...
    <>
      ...
      <div className="container py-5" style={{ minHeight: "80vh" }}>
        <div className="text-center mb-5">
          <h2 className="fw-bold display-6 text-dark">Galeria de Robots</h2>
            ...
            {robots.length > 0 ? (
                    ...
                    <div className="card h-100 shadow-sm border-0 robot-card-modern overflow-hidden">
                      <div
                        ...
                        style={{
                          ...
                          fontSize: "3rem",
                          fontWeight: "800",
                          backgroundColor: getColorFromName(r.nombre || "R"),
                      ...
                      >
                        ...
                        <div className="position-absolute top-0 end-0 m-3">
                          <span
                            className="badge rounded-pill bg-white text-dark shadow-sm px-3 py-2 border-0"
                            style={{
                              fontSize: "0.65rem",
                              letterSpacing: "0.5px",
                              opacity: 0.9,
                          ...
                          >
                            {(r.categoria || "SIN CATEGORIA").toUpperCase()}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="card-body p-4">
                        ...
                        <div className="d-flex flex-column gap-3">
                          <div className="d-flex align-items-center">
                            <div
                              className="icon-box-small me-3 text-primary bg-primary-subtle rounded-circle d-flex align-items-center justify-content-center"
                          ...
                          <div className="d-flex align-items-center border-top pt-2">
                            <div
                              className="icon-box-small me-3 text-success bg-success-subtle rounded-circle d-flex align-items-center justify-content-center"
                              style={{ width: "32px", height: "32px" }}
                            >
                              <FaShieldAlt size={14} />
                            </div>
                            <div className="overflow-hidden">
                              ...
                              <span
                                className="fw-semibold text-secondary text-truncate d-block"
                                style={{ fontSize: "0.9rem" }}
                              >
                                {r.nombreClub || "Independiente"}
                              </span>
                            </div>
                          </div>
                        </div>
              ...
              <div className="text-center py-5">
                <p className="text-muted">
                  No se encontraron robots que coincidan con tu busqueda.
                </p>
              </div>
            )}
          </>
